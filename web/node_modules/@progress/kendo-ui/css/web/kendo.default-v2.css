...
.k-dialog-buttongroup .k-primary.k-state-active,
.k-dialog-buttongroup .k-primary:active,
...
.k-calendar:not(.k-infinite) .k-content .k-state-selected,
.k-calendar:not(.k-infinite) .k-content .k-weekend .k-state-selected,
.k-drag-clue,
.k-event,
...
.k-button-group.k-state-disabled .k-button:not(.k-state-active):hover,
...
.k-dialog-buttongroup .k-primary.k-state-hvoer.k-state-focused,
.k-dialog-buttongroup .k-primary.k-state-hvoer:focus,
.k-dialog-buttongroup .k-primary:hover.k-state-focused,
.k-dialog-buttongroup .k-primary:hover:focus {
  -webkit-box-shadow: inset 0 0 0 2px rgba(0, 0, 0, 0.13);
          box-shadow: inset 0 0 0 2px rgba(0, 0, 0, 0.13);
}
...
.k-grid-header .k-header.k-filterable > .k-link {
  margin-right: -webkit-calc(10px + 1.42857143em);
...
.k-grid-header .k-header-column-menu + .k-link {
  margin-right: -webkit-calc(1.42857143em - 2px);
...
.k-filtercell.k-filtercell-boolean .k-filtercell-wrapper {
  padding-right: -webkit-calc(1.42857143em + 14px);
...
.k-menu .k-item > .k-link .k-i-collapse:before,
.k-menu .k-item > .k-link .k-i-expand-s:before,
.k-menu .k-item > .k-link .k-i-sarrow-s:before {
  margin-left: 4px;
  margin-right: -4px;
}
...
.k-menu .k-item > .k-link .k-i-arrow-w:before,
.k-menu .k-item > .k-link .k-i-expand-e:before,
.k-menu .k-item > .k-link .k-i-expand-w:before,
.k-menu .k-item > .k-link .k-i-expand:before,
.k-menu .k-item > .k-link .k-i-sarrow-e:before,
.k-menu .k-item > .k-link .k-i-sarrow-w:before {
  margin: -8px 0 0;
  position: absolute;
  top: 50%;
}

...
.k-numerictextbox .k-link {
  display: block;
  height: -webkit-calc(0.375rem + 0.75em);
  height: calc(0.375rem + 0.75em);
  overflow: hidden;
  position: relative;
  width: 100%;
}
...
.k-button.k-primary.k-bare.k-state-focused:after,
.k-button.k-primary.k-bare:focus:after,
.k-button.k-primary.k-flat.k-state-focused:after,
.k-button.k-primary.k-flat:focus:after {
  opacity: 0.25;
}
.k-badge {
  background-color: #007bff;
...
.k-grid-header .k-header.k-filterable > .k-link {
  margin-right: -webkit-calc(2px + 0.75rem + 1.5em);
  margin-right: calc(2px + 0.75rem + 1.5em);
}
...
.k-grid-header .k-header-column-menu + .k-link {
  margin-right: -webkit-calc(1.5em + 0.75rem + 2px - 0.75rem);
  margin-right: calc(1.5em + 0.75rem + 2px - 0.75rem);
}
...
.k-filtercell.k-filtercell-boolean .k-filtercell-wrapper {
  padding-right: -webkit-calc(1.5em + 0.75rem + 2px + 0.375rem);
  padding-right: calc(1.5em + 0.75rem + 2px + 0.375rem);
  overflow: hidden;
}
.k-grid-content,

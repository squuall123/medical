...
@blackberry-border-width: 1px;
@blackberry-border-radius: 3px;
@blackberry-switch-radius: 2em;
...
{
    0% { transform: rotate(45deg) scale(.82); }
    25% { transform: rotate(90deg) scale(.86); }
    50% { transform: rotate(135deg) scale(1); }
    75% { transform: rotate(180deg) scale(.86); }
    100% { transform: rotate(225deg) scale(.82); }
}

@-moz-keyframes km-blackberryload2
{
    0% { -moz-transform: rotate(45deg) scale(.82); }
    25% { -moz-transform: rotate(90deg) scale(.86); }
    50% { -moz-transform: rotate(135deg) scale(1); }
    75% { -moz-transform: rotate(180deg) scale(.86); }
    100% { -moz-transform: rotate(225deg) scale(.82); }
}

@-webkit-keyframes km-blackberryload2
{
    0% { -webkit-transform: rotate(45deg) scale(.82); }
    25% { -webkit-transform: rotate(90deg) scale(.86); }
    50% { -webkit-transform: rotate(135deg) scale(1); }
    75% { -webkit-transform: rotate(180deg) scale(.86); }
    100% { -webkit-transform: rotate(225deg) scale(.82); }
}
...
{
    border-top: 0;
    border-radius: 0 0 @blackberry-border-radius @blackberry-border-radius;
}
...
.km-blackberry .km-popup .k-state-border-down
{
    border-bottom: 0;
    margin-top: 1px;
    border-radius: @blackberry-border-radius @blackberry-border-radius 0 0;
}

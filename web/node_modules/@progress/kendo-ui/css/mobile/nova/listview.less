...
.km-nova .km-listgroupinset li:first-child > .km-listview-link {
    border-radius: @nova-inline-border-radius @nova-inline-border-radius 0 0;
}

.km-nova .km-listinset li:last-child > .km-listview-link,
.km-nova .km-listgroupinset li:last-child > .km-listview-link {
    border-radius: 0 0 @nova-inline-border-radius @nova-inline-border-radius;
}
...
.km-nova .km-listgroupinset li:first-child:last-child > .km-listview-link {
    border-radius: @nova-inline-border-radius;
}
...
.km-nova .km-filter-wrap > input::-webkit-input-placeholder { text-align: left; }
.km-nova .km-filter-wrap > input::-moz-placeholder { text-align: left; }
.km-nova .km-filter-wrap > input::-ms-input-placeholder { text-align: left; }

.km-nova .km-filter-wrap > input:focus::-webkit-input-placeholder { text-align: left; }
.km-nova .km-filter-wrap > input:focus::-moz-placeholder { text-align: left; }
.km-nova .km-filter-wrap > input:focus::-ms-input-placeholder { text-align: left; }

...
{
    border-style: solid;
    border-width: 0 0 @fiori-border-width 0;
    line-height: 2.2em;
}
...
{
    border-style: solid;
    border-width: @fiori-border-width;
    border-radius: @fiori-border-radius @fiori-border-radius 0 0;
}

.km-fiori .km-listinset > li,
.km-fiori .km-listgroupinset .km-list > li
{
    border-width: 0 @fiori-border-width @fiori-border-width @fiori-border-width;
}
...
.km-fiori .km-listgroupinset .km-list > li:last-child
{
    border-style: solid;
    border-width: 0 @fiori-border-width @fiori-border-width @fiori-border-width;
    border-radius: 0 0 @fiori-border-radius @fiori-border-radius;
}
...
{
    border-radius: @fiori-inline-border-radius @fiori-inline-border-radius 0 0;
}
...
{
    border-radius: 0 0 @fiori-inline-border-radius @fiori-inline-border-radius;
}
...
{
    border-radius: @fiori-inline-border-radius;
}

.km-fiori .km-group-title
{
    border-style: solid;
    border-width: @fiori-border-width 0;
    line-height: 1.6;
}

...
.km-material {
    .km-list {
        ...
        .km-inline-field {
            ...
            &:first-of-type input[type=text]:not(.k-input),
            &:first-of-type input[type=password],
            &:first-of-type input[type=search],
            &:first-of-type input[type=number],
            &:first-of-type input[type=tel],
            &:first-of-type input[type=url],
            &:first-of-type input[type=email],
            &:first-of-type input[type=file],
            &:first-of-type input[type=month],
            &:first-of-type input[type=color],
            &:first-of-type input[type=week],
            &:first-of-type input[type=date],
            &:first-of-type input[type=time],
            &:first-of-type input[type=datetime],
            &:first-of-type input[type=datetime-local],
            &:first-of-type select:not([multiple]),
            &:first-of-type .k-dropdown,
